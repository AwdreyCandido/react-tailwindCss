...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-5 text-white">
      ...
      <div className={!nav ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500" : "fixed left-[-100%] ease-in duration-200"}>
        <h1 className="w-full text-3xl m-4 font-bold text-[#00df9a]">REACT.</h1>
        <ul className="pt-12 uppercase">
          <li className="border-b border-gray-600 p-4">Home</li>
          <li className="border-b border-gray-600 p-4">Companies</li>
